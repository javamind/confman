 ...
 */
@Repository("parameterValueRepository")
public class ParameterValueRepository implements PaginatedEntityRepository<ParameterValue, Long> {

    @PersistenceContext
    private EntityManager em;

    @Override
    public PaginatedList<ParameterValue> findParamsByCriteria(PaginatedList<ParameterValue> list, SearchBuilder criteria) {
