...
import com.ninjamind.confman.exception.UserNotActivatedException;
...
public class ConfmanUserDetailsService implements UserDetailsService {

    private final Logger log = LoggerFactory.getLogger(ConfmanUserDetailsService.class);
